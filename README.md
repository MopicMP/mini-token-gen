...
> Mini generate secure random tokens and api keys

[![PyPI version](https://badge.fury.io/py/mini-token-gen.svg)](https://pypi.org/project/mini-token-gen/)
...
```bash
pip install mini-token-gen
```

## Quick Start

```python
from mini_token_gen import gen
...
from mini_token_gen import batch
